...
const ApplyFormPage = () => {
    ...
    // Extract unique roles from jobsData
    const availableRoles = [...new Set(jobsData.map(job => job.title))];
    ...
    const validateForm = () => {
        ...
        else if (!/^[\d\s\-\+\(\)]{10,}$/.test(formData.phone.replace(/\D/g, ''))) newErrors.phone = 'Phone number is invalid';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSubmitError('Failed to submit application. Please try again or email careers@aparaitech.com');
        } finally {
                    ...
                    {isSubmitted ? (
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-6">
                                Thank you for applying to Aparaitech. Our hiring team will review your application
                                and contact you within 5-7 business days.
                            </p>
                            <div className="bg-blue-50 p-4 rounded-lg">
                                <p className="text-blue-800">
                                    <strong>Next steps:</strong> Check your email for a confirmation and next steps.
                                </p>
                            </div>
                        </motion.div>
                    ) : (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`input-field ${errors.location ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className={`input-field ${errors.experience ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                                        >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={4}
                                        className={`input-field ${errors.skills ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
